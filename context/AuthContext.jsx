    ...
    const checkAuth = async () => {
        try {
            ...
            if (data.success) {
                ...
                connectSocket(data.user, localStorage.getItem("token")) // token already persisted from a prior session, so this is safe
            }
         } catch (error) {
        ...
        try {
            ...
            if(data.success){
                ...
                try {
                    ...
                    localStorage.setItem("privateKey",rawPrivateKeyB64)
